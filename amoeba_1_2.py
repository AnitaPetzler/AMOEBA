...
#             \|/
#              V
def placegaussians(data = None, Bayes_threshold = 10, use_molex = True, a = None, test = False, file_suffix = None): # returns final_p
	'''
...
def p0gen(vel_range = None, num_gauss = None, modified_data = None, 
	...
	if use_molex:
		...
		p0_0 = [p0_0[a] for a in range(len(p0_0)) if 
...
def sampleposterior(modified_data = None,  # returns (chain, lnprob)
	...
	if use_molex and accepted != []:
		...
		accepted_params = molex(x = accepted_x, modified_data = modified_data, 
			num_gauss = len(accepted_x) / num_param_per_gauss, file_suffix = file_suffix)
	elif accepted != []:
		accepted_params = []
	else:
...
def lnprob(lnprobx = None, modified_data = None, p = [], vel_range = None, 
	...
	if use_molex:
		...
		params = molex(p = p, modified_data = modified_data, 
			num_gauss = num_gauss, file_suffix = file_suffix)
	else:
